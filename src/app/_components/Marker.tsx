    ...
    <div style={{ gridAutoRows: "min-content" }} className="grid gap-4">
      <div className="h-fit rounded bg-white ring-[1px] ring-slate-200">
        <header className="border-b border-slate-100 px-[16px] py-[12px]">
          <div >
          <h3 className="text-slate-800 tracking-tight text-[19px] font-bold hover:cursor-pointer hover:text-blue-800 mt-[2px]">
            <a>#discuss</a>
            
          </h3>
          <div className="text-xs text-slate-600 tracking-tight mb-[0.5px]">
            Discussion threads targeting the whole community
          </div>
          </div>
         
        </header>
        <div className="mt-[2px] border-b border-slate-100 p-4 text-slate-800 hover:cursor-pointer hover:text-blue-800 text-[15px]">
          What was your win this week?
          <div className="text-thin pt-[4px] text-sm text-slate-500">
            11 comments
          </div>
        </div>
        <div className="mt-[2px] leading-[1.6] border-b border-slate-100 p-4 text-slate-800 hover:cursor-pointer hover:text-blue-800 text-[15px]">
          Java vs. JavaScript: Which Language Reigns Supreme in Modern
          Development?
          <div className="pt-[0.5px] ">
            <span className="rounded-md bg-[#fcd34d] p-[4px] text-[13.7px]  text-[#9e350f]">
              New
            </span>
          </div>
        </div>
        <div className="leading-[1.6] border-b border-slate-100 p-4 text-slate-800 hover:cursor-pointer hover:text-blue-800 text-[15px]">
        ...
        <div className="leading-[1.6] border-b border-slate-100 p-4 text-slate-800 hover:cursor-pointer hover:text-blue-800 text-[15px]">
          ...
          <div className="text-thin pt-[3px] text-sm text-slate-500">
            1 comment
          </div>
        </div>
        <div className="leading-[1.6] border-b border-slate-100 p-4 text-slate-800 hover:cursor-pointer hover:text-blue-800 text-[15px]">
          ...
          <div className="pt-[2px]">
            <span className="rounded-md bg-[#fcd34d] p-[4px] text-sm3.7 text-[#9e350f]">
              New
            </span>
          </div>
        </div>
      ...
      <div className="h-fit rounded bg-white ring-[1px] ring-slate-200">
        ...
        <div className="border-b border-slate-100 p-4 text-slate-800 hover:cursor-pointer hover:text-blue-800 text-[15px] leading-[1.6]">
      ...
      <div className="mb-[16px] mt-[8px] border-b border-slate-300 p-[16px] pt-0">
        ...
        <div className="border-b border-transparent p-4  text-slate-800 hover:cursor-pointer hover:bg-white hover:text-blue-700 text-[15px]">
