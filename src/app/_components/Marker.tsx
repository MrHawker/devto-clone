    ...
    <div style={{ gridAutoRows: "min-content" }} className="grid gap-4">
      <div className="h-fit rounded bg-white ring-[1px] ring-slate-200">
        <header className="border-b border-slate-100 px-[16px] py-[12px]">
          <div >
          <h3 className="text-slate-700 tracking-tight text-[19px] font-bold hover:cursor-pointer hover:text-blue-800 mt-[2px]">
            <a>#discuss</a>
        ...
        <div className="mt-[2px] border-b border-slate-100 p-4 text-slate-700 hover:cursor-pointer hover:text-blue-800 text-[15px]">
          What was your win this week?
          <div className="text-thin pt-[4px] text-sm text-slate-500">
            11 comments
          </div>
        </div>
        <div className="mt-[2px] leading-[1.6] border-b border-slate-100 p-4 text-slate-700 hover:cursor-pointer hover:text-blue-800 text-[15px]">
        ...
        <div className="leading-[1.6] border-b border-slate-100 p-4 text-slate-700 hover:cursor-pointer hover:text-blue-800 text-[15px]">
      ...
      <div className="h-fit rounded bg-white ring-[1px] ring-slate-200">
        ...
        <div className="border-b border-slate-100 p-4 text-slate-700 hover:cursor-pointer hover:text-blue-800 text-[15px] leading-[1.6]">
      ...
      <div className="mb-[16px] mt-[8px] border-b border-slate-300 p-[16px] pt-0">
        ...
        <div className="border-b border-transparent p-4  text-slate-700 hover:cursor-pointer hover:bg-white hover:text-blue-700 text-[15px]">
