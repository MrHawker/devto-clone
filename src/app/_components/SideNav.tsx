...
export function SideNav({width}:{width:number}) {
  return (
    <div>
      ...
      <nav className="mb-12">
        <h3 className="font-semibold p-[8px] ">Popular tags</h3>
        <div className="overflow-y-auto h-[310px]">
            <div className="px-[16px] py-[8px] hover:cursor-pointer text-slate-700 hover:rounded-md hover:bg-blue-600 hover:bg-opacity-10 hover:text-blue-800 hover:underline">#webdev</div>
            <div className="px-[16px] py-[8px] hover:cursor-pointer text-slate-700 hover:rounded-md hover:bg-blue-600 hover:bg-opacity-10 hover:text-blue-800 hover:underline">#webdev</div>
            <div className="px-[16px] py-[8px] hover:cursor-pointer text-slate-700 hover:rounded-md hover:bg-blue-600 hover:bg-opacity-10 hover:text-blue-800 hover:underline">#webdev</div>
            <div className="px-[16px] py-[8px] hover:cursor-pointer text-slate-700 hover:rounded-md hover:bg-blue-600 hover:bg-opacity-10 hover:text-blue-800 hover:underline">#webdev</div>
            <div className="px-[16px] py-[8px] hover:cursor-pointer text-slate-700 hover:rounded-md hover:bg-blue-600 hover:bg-opacity-10 hover:text-blue-800 hover:underline">#webdev</div>
      ...
      <footer className="text-sm">
            <p className=" text-slate-500">
                <span className="text-blue-700 hover:text-blue-800 hover:underline hover:cursor-pointer font-semibold">DEV Community </span>
                <span>A constructive and inclusive social network for software developers. With you every step of your journey.</span>
                
            </p>
            <p className="mt-4  text-slate-500">
                <span>Built on </span>
                <span className="text-blue-700 hover:text-blue-800 hover:underline hover:cursor-pointer">Forem</span>
                <span> — the </span>
                <span className="text-blue-700 hover:text-blue-800 hover:underline hover:cursor-pointer">open source </span>
                <span>software that powers </span>
                <span className="text-blue-700 hover:text-blue-800 hover:underline hover:cursor-pointer">DEV </span>
                <span>and other inclusive communities.</span>
            </p>
            <div className="mt-4  text-slate-500">
                <span>Made with love and </span>
                <span className="text-blue-700 hover:text-blue-800 hover:underline hover:cursor-pointer">Ruby on Rails.</span>
                <div>DEV Community © 2016 - 2024.</div>
            </div>
