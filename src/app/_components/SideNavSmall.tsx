...
export function SideNavSmall({
  ...
  return <div className="w-screen h-screen flex z-[100] fixed top-0 left-0 overflow-y-scroll overscroll-contain">
    ...
    <nav className="w-[300px] bg-white overflow-y-scroll h-screen">
        ...
        <nav className="mb-4 text-[15.7px] tracking-tight ">
        <h2 className="py-[8px] pl-[12px] font-semibold">Other</h2>
        <div className="flex px-[16px] py-[8px] text-slate-700 hover:cursor-pointer hover:rounded-md hover:bg-blue-600 hover:bg-opacity-10 hover:text-blue-800 hover:underline decoration-[1.5px]">
          <span className="ml-[-8px] mr-[8px]">
            <svg
              xmlns="http://www.w3.org/2000/svg"
      ...
      <div className="mb-4 flex justify-start">
        <a className="p-[8px] hover:cursor-pointer hover:rounded-md hover:bg-blue-600 hover:bg-opacity-10 hover:fill-blue-800">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            width="24"
            height="24"
            viewBox="0 0 24 24"
            role="img"
            aria-labelledby="at67q1i9gkdo7835mzo8ydhsje37cvhq"
          >
            <title id="at67q1i9gkdo7835mzo8ydhsje37cvhq">Twitter</title>
        ...
        <a className="p-[8px] hover:cursor-pointer hover:rounded-md hover:bg-blue-600 hover:bg-opacity-10 hover:fill-blue-800">
          <svg
            ...
            viewBox="0 0 24 24"
            role="img"
            aria-labelledby="agc1pa9pd9uzqed8cboqq58g63w2kre3"
          >
            <title id="agc1pa9pd9uzqed8cboqq58g63w2kre3">Facebook</title>
        ...
        <a className="p-[8px] hover:cursor-pointer hover:rounded-md hover:bg-blue-600 hover:bg-opacity-10 hover:fill-blue-800">
          <svg
            ...
            viewBox="0 0 24 24"
            role="img"
            aria-labelledby="ar78sn5kq7id7c1nochmd3l8p78008m0"
          >
            <title id="ar78sn5kq7id7c1nochmd3l8p78008m0">Github</title>
        ...
        <a className="p-[8px] hover:cursor-pointer hover:rounded-md hover:bg-blue-600 hover:bg-opacity-10 hover:fill-blue-800">
          <svg
            ...
            viewBox="0 0 24 24"
            role="img"
            aria-labelledby="apcnygupubk6st5p4s7wuc7uvqaviu3m"
          >
            <title id="apcnygupubk6st5p4s7wuc7uvqaviu3m">Instagram</title>
        ...
        <a className="p-[8px] hover:cursor-pointer hover:rounded-md hover:bg-blue-600 hover:bg-opacity-10 hover:fill-blue-800">
          <svg
            ...
            viewBox="0 0 24 24"
            role="img"
            aria-labelledby="ahlmpc8z7hudkz4fmpf9697lrn4ajsxk"
          >
            <title id="ahlmpc8z7hudkz4fmpf9697lrn4ajsxk">Twitch</title>
        ...
        <a className="p-[8px] hover:cursor-pointer hover:rounded-md hover:bg-blue-600 hover:bg-opacity-10 hover:fill-blue-800">
          <svg
            ...
            viewBox="0 0 24 24"
            role="img"
            aria-labelledby="anj9vyrop0hkvj4okn5zq2688kf825he"
          >
            <title id="anj9vyrop0hkvj4okn5zq2688kf825he">Mastodon</title>
