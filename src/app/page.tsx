...
import { SideNavSmall } from "./_components/SideNavSmall";
...
export default function Home() {
  ...
  return (
    <main className="antialiased">
      <HeadNav toggle={toggle} setToggle={setToggle} width={width}/>
      <div className="flex justify-center bg-[#f5f5f5]">
        <div className="mx-auto grid max-w-[1380px] p-0 md:grid-cols-[2fr_5fr] md:gap-[17px] md:p-2 lg:grid-cols-[240px_2fr_1fr] lg:p-4">
          {width >= 768 ? <SideNav width={width}/> : <SideNavSmall toggle={toggle} setToggle={setToggle} width={width} />}
          <Body  width={width} />
